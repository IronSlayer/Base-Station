...
# Generated: Fri Jul 22 10:09:06 2016
##################################################
...
class bladeRF_transceiver(gr.top_block):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.binary_slicer, 0), (self.blks2_selector_0_0, 0))    
        self.connect((self.binary_slicer_0, 0), (self.blks2_selector_0_0, 1))    
        ...
        self.connect((self.rational_resampler_0, 0), (self.quadrature_demod_0, 0))    
        self.connect((self.rx_valve_gfsk, 0), (self.xlating_fir_filter_1_0, 0))    
        self.connect((self.rx_valve_gmsk, 0), (self.xlating_fir_filter_1, 0))    
...
def main(top_block_cls=bladeRF_transceiver, options=None):
